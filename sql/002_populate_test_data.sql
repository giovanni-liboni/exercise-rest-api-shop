...
INSERT INTO items(id, producer, description, price, category) VALUES (1,'Beier Ltd','Et sunt culpa unde distinctio quos.',244.30, 'garden'),
                           (2,'Parker, Hyatt and Kris','Quos vel ut esse incidunt minima minima quae.',302.10, 'home'),
                           (3,'Kutch Ltd','Earum aliquid deleniti beatae quibusdam inventore itaque velit voluptas.',110.13, 'electronic'),
                           (4,'Wisozk-Larson','Quae quis laborum odio provident.',13.20, 'garden'),
                           (5,'Dickinson, Collins and Cremin','Enim provident velit blanditiis ut exercitationem.',213.41, 'home');
